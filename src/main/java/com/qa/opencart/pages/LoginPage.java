...
public class LoginPage {
	...
	private By headerReturningCustomer = By.xpath("//h2[text()='Returning Customer']");//p
	...
	//p
	@Step("cheking search text box exist")
	public boolean isSearchTextboxExist() {
		return eleUtil.checkElementIsDisplayed(searchTextbox);
		
	}
	//p
	@Step("checking header new customer")
	public boolean isheaderNewCustomerExist() {
		return eleUtil.checkElementIsDisplayed(headerNewCustomer);
	}
	
	//p
	@Step("checking header returning customer")
	public boolean isheaderReturningCustomerExist() {
			return eleUtil.checkElementIsDisplayed(headerReturningCustomer);
	...
	@Step("login with usernme {0} and password {1}")
	...
	@Step("login with wrong usernme {0} and password {1}")
