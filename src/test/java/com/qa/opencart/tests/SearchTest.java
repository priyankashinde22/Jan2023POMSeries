...
public class SearchTest extends BaseTest{
	...
	@Test(dataProvider = "productDataWithSearchKey", dataProviderClass=ProductDataProvider.class) //data driven approach
	...
	public void ProductImagesTest(String searchKey, String productName, int expimagesCount) {
		...
		//login->acc->resultpage->productinfo->cart=====page chaining model or zig zag model
		//data driven approach or parameterization[ex=macbook, imac
	}
